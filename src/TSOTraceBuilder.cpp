...
bool TSOTraceBuilder::schedule_replay(int *proc, int *aux, int *alt, bool *dryrun)
{
...
bool TSOTraceBuilder::schedule_thread(int *proc, unsigned p)
{
...
void TSOTraceBuilder::squeezeLastEvent()
{
...
void TSOTraceBuilder::mergeInvisibleEvents()
{
  if(prefix.size() > 1 &&
